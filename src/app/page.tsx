        ...
        >
          <div>
            <h2 className="text-2xl md:text-4xl font-bold text-center text-gray-100">
              ...
              <span className="text-purple-600">Desafio de Emagrecimento</span>{' '}
              em 16 Dias
            </h2>
            ...
            <p className="text-center text-gray-400 text-base md:max-w-[60%] mx-auto mt-4">
              ...
              abordagem prática, eficaz e sustentável para alcançar seus
              objetivos de perda de peso. Aqui está como o desafio funciona
            </p>
          </div>
          ...
          <div className="flex flex-col items-center w-full max-w-[600px] gap-6 mx-auto">
            ...
            <div className="p-6 bg-[#2e2a41] rounded-lg shadow-md w-full">
              ...
              <p className="text-left text-gray-400 text-sm mx-auto mt-4">
                Acesse rotinas de exercícios adaptáveis e eficazes, perfeitas
                para qualquer nível de condicionamento, integradas facilmente em
                sua rotina diária.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="p-6 bg-[#2e2a41] min-h-[400px] rounded-lg shadow-lg flex flex-col items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-center text-gray-400 text-sm mx-auto mt-2">
                    Explore cardápios e receitas que aceleram o metabolismo e
                    são fáceis de preparar, projetados para nutrir seu corpo e
                    mente.
                  </p>
                </div>
              </div>
              <div className="p-6 bg-[#2e2a41] min-h-[400px] rounded-lg shadow-lg flex flex-col items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-center text-gray-400 text-sm mx-auto mt-2">
                    Emagreça de vez com o chá natural que acelera o metabolismo
                    e elimina gordura. Testado e aprovado por dezenas de
                    mulheres no Brasil!
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 bg-[#2e2a41] min-h-[400px] rounded-lg shadow-lg flex flex-col items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-center text-gray-400 text-sm mx-auto mt-2">
                    Descubra rotinas de exercícios que você pode amar, com
                    vídeos motivacionais para todos os níveis, projetados para
                    queimar calorias e fortalecer o corpo.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <ul className="flex flex-col gap-3">
                  <li className="text-purple-950 font-bold flex items-center gap-2 text-lg">
                    ...
                    />{' '}
                    Mulheres que querem emagrecer de forma saudável e
                    definitiva.
                  </li>
                  <li className="text-purple-950 font-bold flex items-center gap-2 text-lg">
                    <SealCheck
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-20">
              <div className="flex flex-col">
                ...
                >
                  ...
                  devolvemos 100% do seu dinheiro. Sem perguntas, sem
                  burocracia.{' '}
                  ...
                  <br />
                  <br />
                  Você terá 7 dias para acessar e aplicar nosso guia e, não
                  vendo a gordurinha derreter e ir embora durante esse período,
